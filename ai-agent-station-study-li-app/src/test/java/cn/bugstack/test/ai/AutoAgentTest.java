...
public class AutoAgentTest {
    ...
    public void test_dynamic_multi_step_execution() {
        ...
        userInput = "搜索 springboot 相关知识，生成4个主要内容章节。每个章节要包括课程内容和配套示例代码。并发对应章节创建对md文档，方便小白伙伴学习。输出地址为 C:\\Users\\erbao\\Desktop";
    ...
    public McpSyncClient stdioMcpClient() {
        var stdioParams = ServerParameters.builder("F:\\work\\node\\npx.cmd")
                .args("-y", "@modelcontextprotocol/server-filesystem", "C:\\Users\\erbao\\Desktop", "C:\\Users\\erbao\\Desktop")
                .build();
