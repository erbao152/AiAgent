...
import cn.bugstack.test.ai.advisors.RagAnswerAdvisor;
...
//                .defaultTools(new SyncMcpToolCallbackProvider(sseMcpClient01(), sseMcpClient02()))
    ...
    public McpSyncClient sseMcpClient01() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://36.150.231.167:8102").build();
    ...
    public McpSyncClient sseMcpClient02() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://36.150.231.167:8101").build();
