...
import cn.bugstack.api.IAiClientModelAdminService;
import cn.bugstack.api.dto.AiClientModelQueryRequestDTO;
import cn.bugstack.api.dto.AiClientModelRequestDTO;
import cn.bugstack.api.dto.AiClientModelResponseDTO;
import cn.bugstack.api.response.Response;
import cn.bugstack.infrastructure.dao.IAiClientModelDao;
import cn.bugstack.infrastructure.dao.po.AiClientModel;
    ...
    public Response<List<AiClientModelResponseDTO>> queryAiClientModelList(@RequestBody AiClientModelQueryRequestDTO request) {
        try {
            ...
            if (StringUtils.hasText(request.getModelId())) {
                ...
                log.info("请求未包含参数，查询所有model配置信息");
                aiClientModels = aiClientModelDao.queryAll();
            }
